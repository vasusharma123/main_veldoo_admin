...
class RideController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if ($request->ajax()) {
            ...
            $data = Ride::select(['rides.id','rides.user_id', 'rides.pickup_address','rides.dest_address','rides.ride_time','rides.distance','rides.status','rides.additional_notes','rides.ride_cost','users.first_name','users.last_name', 'vehicles.vehicle_number_plate','prices.seating_capacity','payment_methods.name AS payment_name']) 
            ...
            return Datatables::of($data)
                           ...
                           return $status;
                            ...
                            ->addColumn('date', function ($row) {
                                ...
                                return ucfirst($row->additional_notes);
                            ...
                            ->rawColumns(['action','status','driver','day','date','car','seat_capacity','pick_up','drop_off','distance','cash','week','guest','comment','payment','ride_cost'])
                            ->make(true);
        }
