...
class AddServiceProviderIdToExpensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('expenses', function (Blueprint $table) {
            $table->dropForeign('expenses_service_provider_id_foreign');
            $table->dropIndex('expenses_service_provider_id_index');
        });
