                                                                ...
                                                                <div class="row w-100 m-0">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputText" id="name" name="name" placeholder="Service provider" />
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputText" id="name" name="name" placeholder="Surname" />
                                                                            <label for="name">Enter admin surname</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            <input type="tel" class="form-control inputText" id="phone1" name="phone1" placeholder="1234" />
                                                                            <label for="phone1">Example: +41 123 456 7899</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            <input type="email" class="form-control inputText" id="email" name="email" placeholder="company@email-address.com" />
                                                                            <label for="email">Example: admin@email-address.com</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputText" id="address" name="address" placeholder="Street" />
