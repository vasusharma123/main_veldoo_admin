...
<body style="background: #f9f9f9;padding: 20px;overflow-x: hidden;">
    <div class="email_template" >
        <div class="email_body" style=" max-width: 594px; margin:auto; background: white;">
            ...
            <div class="main_body">
                <h1 class="title" style="color: #060F21; font-size: 35px; font-weight: 700; text-align: center; margin: 50px 45px 70px 45px;">Your Test Period ending tonight</h1>
                <img src="{{ asset('images/email_templates/orange_trip.png')}}" alt="top_point" style="max-width: 532px;margin: auto;display: block;"/>
                ...
                <img src="{{ asset('images/email_templates/leaf_weather.png')}}" alt="Search" style="max-width: 222px; margin: auto; padding-top: 57px; display: block; padding-bottom: 50px;"/>
