								...
								<div class="row p-t-5">
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-md-2">
												<?php
												echo Html::image(($user->image?config('app.url_public').'/'.$user->image:asset('no-images.png')), 'sidebar logo', ['id' => 'previewimage', 'width' => '50', 'height' => '50']);
												?>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::text('first_name', $user->first_name, ['class' => 'form-control', 'required' => true]);
											?>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<?php
												...
												echo Form::text('last_name', $user->last_name, ['class' => 'form-control', 'required' => true]);
											?>
										</div>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::text('email', $user->email, ['class' => 'form-control', 'required' => true]);
											?>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::text('country', $user->country, ['class' => 'form-control', 'required' => false]);
											?>
											@error('country')
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::text('state', $user->state, ['class' => 'form-control']);
											?>
											@error('state')
												<span class="invalid-feedback" role="alert">
													<strong>{{ $message }}</strong>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::text('city', $user->city, ['class' => 'form-control', 'required' => false]);
											?>
											@error('city')
												<span class="invalid-feedback" role="alert">
													<strong>{{ $message }}</strong>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::text('zip', $user->zip, ['class' => 'form-control', 'required' => false]);
											?>
											@error('zip')
												<span class="invalid-feedback" role="alert">
													<strong>{{ $message }}</strong>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											echo Form::select('status', ['1' => 'Active', '0' => 'In-active'], $user->status, ['class' => 'form-control custom-select', 'required' => true]);
											?>
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		var input = $('#Regphones').intlTelInput("setNumber", "{{ '+'.(str_replace('+','',$user->country_code)).$user->phone }}");
		input.on("countrychange", function() {
			$(".country_code").val($("#Regphones").intlTelInput("getSelectedCountryData").dialCode);
		});

		var input = $('#RegAlterenatePhones').intlTelInput("setNumber", "{{ ($user->second_phone_number?'+'.(str_replace('+','',$user->second_country_code)).$user->second_phone_number:'+1') }}");
		input.on("countrychange", function() {
