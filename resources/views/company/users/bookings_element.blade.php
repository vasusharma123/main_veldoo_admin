<div class="table-responsive">
	<table class="table table-bordered">
		<thead class="thead-light">
			...
			<th class="custom-userData-sort sort-th-sec" orderBy="driver_first_name" order="asc">
				<i class="fa fa-fw fa-sort"></i>
				Driver Name
			</th>
			<th class="custom-userData-sort sort-th-sec" orderBy="rider_first_name" order="asc">
				<i class="fa fa-fw fa-sort"></i>
				Rider Name
			</th>
