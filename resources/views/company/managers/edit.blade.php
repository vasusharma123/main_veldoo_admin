				...
				<div class="col-lg-12">
					<div class="card card-outline-info">
						...
						<div class="card-body">
							...
							{{ Form::open(array('url' => route('managers.update',$manager->id),'class'=>'form-horizontal form-material','id'=>'store','enctype' => 'multipart/form-data')) }}
								@method('put')
								<div class="form-body">
									<div class="row p-t-4">
										<div class="col-md-8">
											...
											<div class="" style="margin-bottom:20px">
                                                ...
                                                <input type="text" name="phone" id="Regphones" value="{{ $manager->phone }}" class="form-control">
												<input type="hidden" id="test1" value="{{ $manager->country_code }}" name="country_code" />
											</div>
                                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function(){
		...
		var input = $('#Regphones').intlTelInput("setNumber", "{{ '+'.$manager->country_code.$manager->phone }}");
