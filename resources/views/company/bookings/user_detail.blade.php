					...
					<div class="card-body">
						...
						<div class="col-md-8">
							<div class="table-responsive">
								...
								@if( Request::is('admin/'.$id.'/upcoming-booking/user'))
									<a href="{{url('admin/upcoming-bookings')}}" class="btn btn-inverse">{{trans('admin.Back')}}</a>
								@elseif( Request::is('admin/'.$id.'/past-booking/user'))
									<a href="{{url('admin/past-bookings')}}" class="btn btn-inverse">{{trans('admin.Back')}}</a>
								@elseif( Request::is('admin/'.$id.'/current-booking/user'))
									<a href="{{url('admin/current-bookings')}}" class="btn btn-inverse">{{trans('admin.Back')}}</a>
								@endif
