<div class="table-responsive">
	<table class="table table-bordered">
		...
		<th class="custom-userData-sort sort-th-sec" orderBy="first_name" order="asc">
			...
			<th class="custom-userData-sort sort-th-sec" orderBy="ride_type" order="asc">
				<i class="fa fa-fw @if($orderby == 'ride_type' && $order=='asc') fa-sort-asc @elseif($orderby == 'ride_type' && $order=='desc') fa-sort-desc @else fa-sort @endif"></i>
				Ride Type
			</th>
			<th>Status</th>
			<th>Action</th>
					...
					<td class="">
						<div class="btn-group">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a class="dropdown-item" href="{{ url('admin/upcoming-bookings-detail/'.$record->id) }}">View</a></li>
								@if( Request::is('admin/upcoming-bookings'))
								<li><a href="{{ url('admin/'.$record->id.'/upcoming-booking/user/') }}" class="dropdown-item">User Detail</a></li>
								@elseif( Request::is('admin/past-bookings'))
								<li><a href="{{ url('admin/'.$record->id.'/past-booking/user/') }}" class="dropdown-item">User Detail</a></li>
								@elseif( Request::is('admin/current-bookings'))
								<li><a href="{{ url('admin/'.$record->id.'/current-booking/user/') }}" class="dropdown-item">User Detail</a></li>
								@endif
							</ul>
						</div>
					</td>
