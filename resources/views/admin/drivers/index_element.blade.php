		...
		<tbody>
			@foreach ($records as $record)
				...
				<tr>
					...
					<td class="actionbtns">
						<a href="{{ route('drivers.edit',$record->id) }}" class="actionbtnsLinks"><img src="{{ URL::asset('public') }}/assets/images/veldoo/editpen.png" class="img-fluid tableIconsbtns edit_btn" alt="edit"></a>
