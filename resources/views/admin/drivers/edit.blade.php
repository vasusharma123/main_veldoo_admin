									...
									<div class="row p-t-5">
										...
										<div class="form-group">
											...
											<!-- <div class="form-group">
												...
												//echo Form::text('country_code',null,['class'=>'form-control','required'=>true]);
												?>
											</div> -->
											<div class="" style="margin-bottom: 20px">
												...
												?>
												<input class="form-control " id="Regphones" required="" value="{{ '+'.$record->country_code.' '.$record->phone }}" name="phone" type="text" >
												<input type="hidden" value="{{'+'.$record->country_code}}" id="test1" placeholder="" name="country_code" />
											</div>
