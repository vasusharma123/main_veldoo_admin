...
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<th class="custom-userData-sort sort-th-sec" orderBy="first_name" order="asc">
				...
				<th class="custom-userData-sort sort-th-sec" orderBy="ride_cost" order="asc">
				<i class="fa fa-fw @if($orderby == 'ride_cost' && $order=='asc') fa-sort-asc @elseif($orderby == 'ride_cost' && $order=='desc') fa-sort-desc @else fa-sort @endif"></i>
				Price
			</th>
		...
		<?php //if($record->id == 1817) { echo $record->id; echo "<br>"; echo $record->driver_id; echo dd($record->driver); } ?>
		<tr>
					<td>{{ $record->id }}</td>
					...
					?>
					@if(count($driver_ids) == 1 && $record->status != 0)
