 ...
 <!-- Main wrapper - style you can find in pages.scss -->
    <!-- ============================================================== -->
    <section id="wrapper">
		@if(!empty($setting['admin_background']) && file_exists('public/storage/'.$setting['admin_background']))
		...
		@endif
            ...
            <div class="login-box card">
                <div class="card-body">
					...
					{{ Form::open(array('url' => 'verifyOtp','class'=>'form-horizontal form-material','id'=>'verificationform')) }}
