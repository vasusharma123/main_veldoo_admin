                                    ...
                                    @include('company.company_flash_message') 
                                        <div class="form-row">
                                            ...
                                            <div class="col-12 p-0">
                                                ...
                                                <img src="assets/imgs/brand_logo.png" alt="Logo" class="img-fluid logo_img"/>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group position-relative has_validation">
                                                    ...
                                                    <!-- <input type="tel" id="phone" class="form-control loginField" placeholder="Enter Number" aria-label="Phone Number" required> -->
                                                       <input type="email" name="email" class="form-control loginField" placeholder="Enter username or email" required/>
                                                       <img src="assets/imgs/envelope.png" class="img-fluid loginFieldIcon" alt="Email envelope"/> 
                                                    </div>
                                                ...
                                                <div class="form-group position-relative has_validation">
                                                    ...
                                                    <div class="field position-relative">
                                                        ...
                                                        <img src="assets/imgs/password_lock.png" class="img-fluid loginFieldIcon" alt="Password Lock"/>
                                                        <img src="assets/imgs/see_password.png" class="img-fluid loginFieldIcon password_icon" alt="Password Lock"/>
                                                    </div>
