                    ...
                    <div class="leftcontent">
                        ...
                        <ul class="list-group paidList">
                            ...
                            <li class="list-group-item">
                                ...
                                <span class="RightItmes">{{ $latest_plan->currency.' '.$latest_plan->paid_amount }}</span>
                            </li>
                            <li class="list-group-item">
                                <span class="LeftItmes">Next Payment</span>
                                <span class="RightItmes">{{ $latest_plan->plan->currency_type.' '.$latest_plan->plan->charges }}</span>
                            </li>
                        </ul>
