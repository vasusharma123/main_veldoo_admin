                ...
                <article class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 col-12 ps-0">
                            ...
                            {{ Form::open([
                                'url' => 'service-provider/register_step3_submit',
                                'class' => 'input_form
                            ...
                            @foreach ($prices as $price_key => $price)
                                @foreach ($price->cars as $vehicle_key => $vehicle)
                                    <div
                                        class="row w-100 m-0 gx-4 @php if($price_key !=0 && $vehicle_key == 0){ echo 'mt-5';} elseif ($vehicle_key !=0 ) { echo 'mt-2';} @endphp">
                                        @if ($vehicle_key == 0)
                                            <div class="col-12">
                                                <h2 class="subtitle less_left_space required_field">{{ $price->car_type }}
                                                </h2>
                                            </div>
                                        @endif
                                        <div
                                            class="col-lg-2 col-md-2 col-sm-6 col-12 offset-1 col_form_settings mb-2 align-self-end text-center">
                                        ...
                                        <div
                                            ...
                                            <small
                                                class="sort_info normal_info">{{ __('Configure your car model and plate
                                                                                            number') }}</small>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 col_form_settings mb-2">
                                            ...
                                            <input type="hidden" name="vehicle_id[]"
                                                value="{{ $vehicle->id ?? old('vehicle_id.' . $loopCount) }}">
                                            <input type="text" name="model[]" class="form-control input_text"
                                                value="{{ $vehicle->model ?? old('model.' . $loopCount) }}"
                                                placeholder="Car {{ $vehicle_key + 1 }}" required />
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 col_form_settings mb-2">
                                            ...
                                            <input type="text" name="vehicle_number_plate[]"
                                                class="form-control input_text"
                                                value="{{ $vehicle->vehicle_number_plate ?? old('vehicle_number_plate.' . $loopCount) }}"
                                                placeholder="AA{{ $vehicle_key + 1 }}{{ $vehicle_key + 1 }}" required />
                            ...
                            <div class="row w-100 m-0 gx-4 mt-4">
                                ...
                                <div
                                    class="col-lg-9 col-md-9col-sm-12 col-12 col_form_settings mb-2 text-left align-self-end">
                                    <small class="sort_info normal_info"><b class="md_label">{{ __('NOTE') }}:</b>
                                        {{ __('With test
                            ...
                            <div class="row w-100 m-0 gx-4 sm_form_row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mt-3 mb-3 text-end">
                                    <a class="btn submit_btn full_width_btn blue_btn"
                                        href="{{ route('service-provider.register_step2', ['token' => $token]) }}">
