                                        ...
                                        <div class="row m-0 w-100">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12 pe-lg-0">
                                                <div class="thankyoubox">
                                                    ...
                                                    <p class="thnxsubpara">Start using APP with your created account. Follow
                                                        instruction in your email. </p>
                                                </div>
                                                <div class="loginoptionbox">
                                                    <p class="notpara mb-0"><strong>NOTE:</strong><a href="#"> Need
                                                            help? Contact our Help Center.</a></p>
                                                    <a href="/admin"><button
                                                            class="btn submit_btn planBtnSelect subsCribeBtn mt-0">Log
                                                            in</button></a>
                                                </div>
                                            </div>
                                        </div>
