                ...
                <article class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 ps-0">
                            ...
                            {{ Form::open(['url' => 'service-provider/register_submit', 'class' => 'input_form', 'id' => 'registerform', 'method' => 'post']) }}
                            ...
                            <div class="row w-100 m-0 gx-4">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" name="first_name" class="form-control input_text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" name="last_name" class="form-control input_text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" name="site_name" class="form-control input_text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" name="addresses" class="form-control input_text"
                                        value="{{ old('addresses') }}" required />
                                    @error('addresses')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="number" name="zip" class="form-control input_text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" name="city" class="form-control input_text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" name="country" class="form-control input_text"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input class="form-control" name="country_code_iso" type="hidden" id="iso2"
                                        value="{{ old('country_code_iso') ?? 'ch' }}">
                                    <input class="form-control" name="country_code" type="hidden" id="country_code"
                                        value="{{ old('country_code') ?? 41 }}">
                                    <input type="text" name="phone" class="form-control input_text"
                                        id="country_code_box" value="{{ old('phone') }}" required />
                                    @error('phone')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="email" name="email" class="form-control input_text"
