                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 ps-0">
                            <div class="top_form_heading text-center position-relative">
                                ...
                                <h3 class="form_bold_text">
                                    {{ __('Please add your Driver details to login to the Driver APP') }}</h3>
                                <small
                                    class="sort_info normal_info">{{ __('Thank you for registering with Veldoo. Please fill out the following forms to finish your registration and begin testing the apps.') }}</small>
                            </div>
                            @include('service_provider.includes.flash_alerts')
                            {{ Form::open(['url' => 'service-provider/register_step1_submit', 'class' => 'input_form position-relative', 'id' => 'registerform', 'method' => 'post']) }}
                            ...
                            <div class="row w-100 m-0 gx-4">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="hidden" name="driver_id[]"
                                        value="{{ !empty($drivers[0]) ? $drivers[0]->id : old('driver_id.0') }}">
                                    <input type="text" class="form-control input_text"
                                        placeholder="{{ __('Enter driver name') }}" name="first_name[]"
                                        value="{{ !empty($drivers[0]) ? $drivers[0]->first_name : old('first_name.0') }}"
                                        required />
                                    @error('first_name.0')
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" class="form-control input_text" placeholder="Enter driver surname"
                                        name="last_name[]"
                                        value="{{ !empty($drivers[0]) ? $drivers[0]->last_name : old('last_name.0') }}"
                                        required />
                                    @error('last_name.0')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input class="form-control" name="country_code_iso[]" type="hidden" id="iso2_0"
                                        value="{{ !empty($drivers[0]) ? $drivers[0]->country_code_iso : old('country_code_iso.0') ?? 'ch' }}">
                                    <input class="form-control" name="country_code[]" type="hidden" id="country_code_0"
                                        value="{{ !empty($drivers[0]) ? $drivers[0]->country_code : old('country_code.0') ?? 41 }}">
                                    <input type="text" name="phone[]" id="phone_0" class="form-control input_text"
                                        value="{{ !empty($drivers[0]) ? $drivers[0]->phone : old('phone.0') }}" required />
                                    @error('phone.0')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <div class="field position-relative">
                                        <input type="password" name="password[]" class="form-control input_text"
                                            placeholder="Enter your password" />
                                        <img src="{{ asset('service_provider_assets/imgs/eye-outline.png') }}"
                                            class="img-fluid loginFieldIcon password_icon" alt="Password Lock">
                                    </div>
                                    @error('password.0')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <div class="field position-relative">
                                        <input type="password" name="password_confirmation[]"
                                            class="form-control input_text" placeholder="Re-enter your password" />
                                        <img src="{{ asset('service_provider_assets/imgs/eye-outline.png') }}"
                                            class="img-fluid loginFieldIcon password_icon" alt="Password Lock">
                                    </div>
                            ...
                            <div class="row w-100 m-0 gx-4">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="hidden" name="driver_id[]"
                                        value="{{ !empty($drivers[1]) ? $drivers[1]->id : old('driver_id.1') }}">
                                    <input type="text" class="form-control input_text" name="first_name[]"
                                        value="{{ !empty($drivers[1]) ? $drivers[1]->first_name : old('first_name.1') }}"
                                        placeholder="Enter Enter driver name" />
                                    @error('first_name.1')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                        <small class="sort_info">{{ __('Please enter driver first name') }}</small>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input type="text" class="form-control input_text" name="last_name[]"
                                        value="{{ !empty($drivers[1]) ? $drivers[1]->last_name : old('last_name.1') }}"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12 col_form_settings mb-2">
                                    ...
                                    <input class="form-control" name="country_code_iso[]" type="hidden" id="iso2_1"
                                        value="{{ !empty($drivers[1]) ? $drivers[1]->country_code_iso : old('country_code_iso.1') ?? 'ch' }}">
                                    <input class="form-control" name="country_code[]" type="hidden" id="country_code_1"
                                        value="{{ !empty($drivers[1]) ? $drivers[1]->country_code : old('country_code.1') ?? 41 }}">
                                    <input type="text" name="phone[]" id="phone_1" class="form-control input_text"
                                        value="{{ !empty($drivers[1]) ? $drivers[1]->phone : old('phone.1') }}" />
                                    @error('phone.1')
                                        <div class="text-danger">{{ $message }}</div>
                                    @else
                                        <small class="sort_info">{{ __('Example:') }} +43 xxxxxx1234</small>
