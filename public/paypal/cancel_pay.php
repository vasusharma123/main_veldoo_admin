...
if(!empty($_REQUEST['amount']) && !empty($_REQUEST['currency']) && !empty($_REQUEST['booking_id']))
{
...
<div class="product">
    ...
    <input type="hidden" name="item_name" value="Cancellation Fee">   
    ...
    <input type="hidden" name="cancel_return" value="http://oremtechnologies.com/~apis~/wesaloon/cron/cancelpayment">
    <input type="hidden" name="return" value="http://oremtechnologies.com/~apis~/wesaloon/cron/successpayment">
